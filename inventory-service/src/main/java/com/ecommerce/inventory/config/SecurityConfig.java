    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers("GET", "/api/inventory/**").permitAll()
                        .requestMatchers("PUT", "/api/inventory/**").permitAll() // Allow PUT for testing, change to hasRole('ADMIN') in production
                        .requestMatchers("POST", "/api/inventory/**").permitAll() // Allow POST for testing, change to hasRole('ADMIN') in production
                        .requestMatchers("DELETE", "/api/inventory/**").permitAll() // Allow DELETE for testing, change to hasRole('ADMIN') in production
